...
module "high-availability-infrastructure-3" {
  source                = "./modules/k3s-ha"
  aws_prefix            = var.aws_prefix
  aws_access_key        = var.aws_access_key
  aws_secret_key        = var.aws_secret_key
...
module "high-availability-infrastructure-4" {
  source                = "./modules/k3s-ha"
  aws_prefix            = var.aws_prefix
  aws_access_key        = var.aws_access_key
  aws_secret_key        = var.aws_secret_key
...
output "infra4_server1_ip" {
  value = module.high-availability-infrastructure-4.server1_ip
}
output "infra4_server2_ip" {
  value = module.high-availability-infrastructure-4.server2_ip
}
output "infra4_mysql_endpoint" {
  value = module.high-availability-infrastructure-4.mysql_endpoint
}
output "infra4_mysql_password" {
  value     = module.high-availability-infrastructure-4.mysql_password
  sensitive = true
}
output "infra4_rancher_url" {
  value = module.high-availability-infrastructure-4.rancher_url
}
